...
export class LoginComponent implements OnInit {
  ...
  saveUserDetails(data: AuthenticationDetails): void {
    ...
    // }
    this._router.navigate(['pages/sourcedfination']);
  }
  ...
  UpdateMenu(): void {
    ...
    //   );
    // }
    if (this.MenuItems.indexOf('AssetManagenent') >= 0) {
      this.children.push(
        {
          id: 'assetManagenent',
          title: 'Asset Managenent',
          translate: 'NAV.SAMPLE.TITLE',
          type: 'item',
          icon: 'dashboard',
          url: '/pages/asset-management',
        }
      );
    }
    if (this.MenuItems.indexOf('Bot Assembly') >= 0) {
      this.children.push(
        {
          id: 'botassembly',
          title: 'Bot Assembly',
          translate: 'NAV.SAMPLE.TITLE',
          type: 'item',
          icon: 'botassemblyIcon',
          isSvgIcon: true,
          url: '/pages/botassembly',
        }
      );
    }
    if (this.MenuItems.indexOf('Source Definition') >= 0) {
      this.children.push(
        {
          id: 'sourcedfination',
          ...
          translate: 'NAV.SAMPLE.TITLE',
          type: 'item',
          icon: 'sourcedefinitionIcon',
          isSvgIcon: true,
          url: '/pages/sourcedfination',
        }
      );
    }
    if (this.MenuItems.indexOf('Transform') >= 0) {
      this.children.push(
        {
          id: 'transform',
          title: 'Transform',
    ...
    if (this.MenuItems.indexOf('Adopter') >= 0) {
      this.children.push(
        {
          id: 'adopter',
          title: 'Adopter',
